	...
	function onZonesLoad(json) {
		...
		onSelect: function(suggestion, changed) {
			...
			if (polygon) {
				...
				// $("#suggestions").prop("title","Пожалуйста, укажите адрес полностью: улица, дом, квартира");
				// $("#suggestions").tooltip();
				$("[name='dostavka_info'").html("Если что-то пошло не так вы можете связаться с нами когда адрес доставки не входит в зону доставки. <a href='tel:+79148959797' style=''>95-97-97</a>");
